...
/*
let gridTemplateColumnField = document.querySelector('.grid-template-columns');
gridTemplateColumnField.addEventListener('change',function(e){
...
let gridTemplateColumnsField = document.querySelector('.grid-template-columns');
let submitGridTemplateColumns = document.querySelector('#submitGridTemplateColumns');
...
let submitGridTemplateRows = document.querySelector('#submitGridTemplateRows');
